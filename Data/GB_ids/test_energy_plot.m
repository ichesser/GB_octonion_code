...
dat100pre = importdata('stgb100_en.txt'); dat100 = id100pre.data; %energy / geodesic angle plotted for subset of GB's
...
NiGBE_100_test1 = [0; pdata(id100(2:end-1),4); 0]; %NB's are added
NiGBE_100_test2 = dat100(:,3); %already includes NB's

%% Plot GBE energy

figure
plot(ang100,NiGBE_100_test1,ang100,NiGBE_100_test2)

% figure
% plot(NiGBE_100_test1,